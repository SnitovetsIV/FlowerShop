...
public class CutFlower extends NaturalFlower {
    ...
    public CutFlower(int id, double price, Color color, FreshnessType freshness, int stemLength, ReproductionType reproductionType, int storageTime) {
        super(id, price, color, freshness, stemLength, reproductionType);
